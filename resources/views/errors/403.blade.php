            ...
            <div class="container my-auto">
                <div class="row">
                    <div class="col-lg-12 m-auto text-center">
                        <h1 class="display-1 text-bolder text-white">403 Forbidden</h1>
                        <h2 class="text-white">You don't have permission to access this page</h2>
                        <p class="lead text-white">We suggest you to go to the homepage while we solve this issue.</p>
                        <a href="/"><button type="button" class="btn btn-outline-white mt-4">Go to Homepage</button></a>
                    </div>
                </div>
            </div>
        </div>
