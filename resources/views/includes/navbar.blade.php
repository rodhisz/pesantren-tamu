    ...
    <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                ...
                <li class="breadcrumb-item text-sm text-dark active" aria-current="page">@yield('subtitle')</li>
            </ol>
            <h6 class="font-weight-bolder mb-0">@yield('subtitle')</h6>
        </nav>
            ...
            <ul class="navbar-nav  justify-content-end">
                <li class="nav-item dropdown px-3">
                    <a href="javascript:;" class="nav-link text-body p-0 position-relative" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                        <i class="fas fa-user-circle"></i><span class="nav-link-text ms-2 ps-1">{{ Auth::user()->name }}</span>
                    </a>
